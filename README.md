...
<p align="center">
  ...
  <a href="https://github.com/b4k3d/b4track/releases/download/v.1.0.0/B4TRACK-v1.0.0.apk">📱 Download APK</a> ·
...
Cleaning runs locally on your device. No account is required, and links are not sent to a server.

## ✨ Features

- 🔗 Clean links from any app using the Android share menu
- 📋 Automatically clean copied URLs from other apps
- 📎 Automatically copy cleaned links back to the clipboard
...
- 🎛️ Quick Settings tile for instant clipboard cleaning
...
`local.properties` is generated automatically by Android Studio and should not be committed.
...
B4TRACK is released under the [Apache License 2.0](LICENSE).

The Android cleaner is based on the open-source [Untracker](https://github.com/zhanghai/Untracker) project.
